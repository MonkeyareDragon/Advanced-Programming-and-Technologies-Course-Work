...
<h1>helllo</h1>
			...
			<input type="text" id="brand" name="brand" placeholder="<%= product.getBrand() %>">

			<label for="photo">Photo:</label>
			<input type="file" id="photo" name="photo" accept="image/*" placeholder="<%= product.getPhoto() %>">

			<label for="price">Price:</label>
			<input type="number" id="price" name="price" min="0" step="1" placeholder="<%= product.getPrice() %>">

			<label for="stock">Stock:</label>
			<input type="number" id="stock" name="stock" placeholder="<%=  product.getStock() %>" min="0">

			<label for="rating">Rating:</label>
			<input type="number" id="rating" name="rating" min="0" max="5" step="0.1" placeholder="<%= product.getRating() %>">
		
			<button type="submit" onclick="javascript: form.action='UpdateProduct';" >Edit Product</button>
			<button type="submit" class="btn-delete" onclick="javascript: form.action='DeleteProduct';" >Delete Product</button>
