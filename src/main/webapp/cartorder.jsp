	...
	<div data-responsive-table-toolbar="tech-companies"></div>
              <div class="table-responsive" id="tech-companies-wrapper" data-pattern="priority-columns" data-sortable="true">
				...
				Connection con = ConnectionProvider.getConnection();
                      	String query = "Select C.CartID, P.Name, P.Category, P.Brand, P.Price, P.Stock, P.Rating FROM Cart C JOIN Product P ON C.ProductID = P.ProductID JOIN users U ON C.email = U.email";
