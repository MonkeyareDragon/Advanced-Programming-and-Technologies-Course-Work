...
<section class="products" id="products">
    ...
    <div class="filter-buttons">
  	<a href="home.jsp"  data-filter="all" class="buttons">All</a>
  	<a href="home+new&feature.jsp" class="buttons">New & Feature</a>
  	<a href="home+highest+price.jsp" class="buttons">Highest Price</a>
  	<a href="home+highest+rating.jsp" class="buttons active" class="buttons">Highest Rating</a>
	</div>
    ...
    <div class="box-container">
		...
		try {
			Product[] products = DisplayDAO.executeQuery("SELECT * FROM Product ORDER BY Rating DESC");
